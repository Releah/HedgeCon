...
type StoredData = { folders: unknown[]; sessions: unknown[]; macros: unknown[]; uiSettings?: unknown; credentialProfileMappings: Record<string, string>; knownHosts: Record<string, string>; credentialSets: StoredCredential[]; repository?: GitRepository; inventorySettings: InventorySettings; updateSettings: UpdateSettings };
...
const defaults: StoredData = { folders: [], sessions: [], macros: [], credentialProfileMappings: {}, knownHosts: {}, credentialSets: [], inventorySettings: { configured: false, mode: 'local' }, updateSettings: { automaticChecks: true, branch: 'main' } };
...
ipcMain.handle('data:load', () => ({ folders: stored.folders, sessions: stored.sessions, macros: stored.macros, inventorySettings: stored.inventorySettings, uiSettings: stored.uiSettings, credentialProfileMappings: stored.credentialProfileMappings }));
...
ipcMain.handle('data:save', (_event, data: { folders: unknown[]; sessions: unknown[]; macros?: unknown[]; uiSettings?: unknown; credentialProfileMappings?: Record<string, string> }) => {
