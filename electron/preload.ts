...
contextBridge.exposeInMainWorld('hedge', {
  ...
  listUpdateReleases: () => ipcRenderer.invoke('update:list-releases'),
  selectUpdateRelease: (tag: string) => ipcRenderer.invoke('update:select-release', tag),
  downloadUpdate: () => ipcRenderer.invoke('update:download'),
  installUpdate: () => ipcRenderer.invoke('update:install'),
  openLatestRelease: () => ipcRenderer.invoke('update:open-release'),
  openRegexHelp: () => ipcRenderer.invoke('help:regex101'),
  openFeedbackIssue: (input: unknown) => ipcRenderer.invoke('feedback:open-issue', input),
  ...
  writeWikiImage: (pagePath: string, name: string, bytes: Uint8Array) => ipcRenderer.invoke('wiki:write-image', pagePath, name, bytes),
  readWikiImage: (pagePath: string, imagePath: string) => ipcRenderer.invoke('wiki:read-image', pagePath, imagePath),
  ...
  identifyDevice: (connectionId: string, observedText?: string, runProbes?: boolean) => ipcRenderer.invoke('ssh:identify', connectionId, observedText, runProbes),
  sampleDeviceTelemetry: (host: string, identity?: unknown) => ipcRenderer.invoke('ssh:telemetry', host, identity),
  openCompareText: () => ipcRenderer.invoke('compare:open-text'),
  listCompareConnections: () => ipcRenderer.invoke('compare:connections'),
  ...
  writeSerial: (id: string, data: string) => ipcRenderer.send('serial:write', id, data),
  ...
  copyCredentialField: (id: string, field: 'username' | 'password') => ipcRenderer.invoke('credentials:copy-field', id, field),
